const contentLetterSrart_actived = "Cảm ơn ngày 14/07 một ngày tuyệt vời sinh ra chị trên cõi đời." //Lời mở đầu cho bức thư
const mainContentLetter = "❤️❤️Chúc chị Tiên sinh nhật vui vẻ và gặp nhiều may mắn hơn trong công việc lẫn cuộc sống!❤️❤️" //Nội dung của bức thư
...
imgLetter.src = "./img/mainImg.jpg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
...
function createLight(a) {
    ...
    for (var i = 0; i < count; i++) {
        ...
        var moveTime = Math.floor(Math.random() * 4) + 3;
